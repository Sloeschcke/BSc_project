...
def visualize (dir, path, save_path, experiment_string):
    ...
    plt.title(graph_title + " - log sclaed y", size = 16)
    ...
    plt.savefig(str(save_path) + '/' + graph_title +'.png')
    plt.show()
